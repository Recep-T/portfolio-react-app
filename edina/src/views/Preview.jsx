...
const Preview = () => {
	...
	return (
		<div className="edina_tm_intro">
          ...
          <br /> */}
					<br />
					<span className="theme-color">Fast</span> &amp; {"  "}
					<span className="theme-color">Simple</span>
					{/* <span className="theme-color">Pure CSS </span> */}
					{/* <span className="theme-color">Pure CSS </span> */}
				</h3>
				<div
			...
			<div className="copyright">
				<p>
					{" "}
					&copy; {new Date().getFullYear()} Recep Taylanhan by{" "}
